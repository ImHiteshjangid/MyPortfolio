          ...
          <Row className={styles.aboutRow}>
            ...
            <Col md={8} className={styles.textCol}>
              ...
              <p className={styles.description}>
                I'm a focused and enthusiastic programmer with a keen interest in data science and artificial intelligence. Through comprehensive exposure to the underlying concepts and applying them vividly to various projects, my love for these domains came into being. With a solid foundation in data analysis and expertise in programming languages such as Python, SQL, and R, I am committed to continually honing my skills and actively pursuing new challenges to drive my professional growth.
              </p>
              <p className={styles.description}>
